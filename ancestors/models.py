...
class Person(models.Model):
    ...
    birth_date_formatted = models.DateField(null=True, blank=True, verbose_name='Formatiertes Geburtsdatum')
    ...
    death_date_formatted = models.DateField(null=True, blank=True, verbose_name='Formatiertes Sterbedatum')
