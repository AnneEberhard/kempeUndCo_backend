...
from accounts.views import ActivationView, BlacklistTokenView, ChangePasswordView, LoginView, PasswordResetConfirmView, PasswordResetRequestView, RegistrationView
